...
public class WebOrder_TestData {
	...
	@DataProvider(name = "LoginOrangeHRM")
	public Object[][] getDataforOrangeHRMLogin() {
		// Multidimensional Object
		// 3X3 or 4X3 or 4X5 or 2X4
		return new Object[][] {
	...
	@DataProvider(name = "OrangeHRM_LoginAll_TCs")
	public Object[][] getLogin_All_TCs_Scenarios_OrangeHRM() {
		// Multidimensional Object
		// 3X3 or 4X3 or 4X5
		return new Object[][] {
	...
	public Object[][] getOrders_All_TCs_Scenarios() {
		...
		// 3X3 or 4X3 or 4X5
		return new Object[][] {
				//Product,  quantity, name, street, city, state, zip, cardNo, , expiry, Expected Result
				//Correct order
	...
	public Object[][] createOrder_All_TCs() {
		return new Object[][] { 
			...
			{ "FamilyAlbum", "5", "Nguyen", "123 Main St", "Dallas", "75000", "MasterCard", "123456789" ,"12/23", "valid" },
			{ "ScreenSaver", "5", "Nguyen", "123 Main St", "Dallas", "75000", "American Express", "123456789" ,"12/23", "valid" }, 
