...
public class WebOrder_Login_allTCs_UsingColor{

	WebDriver driver;
	@Test(dataProvider="WebOrder_All_Orders_TC",dataProviderClass=WebOrder_TestData.class)
	public void Create_Order(String quantity, String discount, String name, String street, String city, String state, String zip, String cardNo, String expiry, String Exp_Msg) {
		...
		if(Exp_Msg.equalsIgnoreCase("New order has been successfully added."))
		{
		String Act_Msg = driver.findElement(By.xpath("//strong[normalize-space()='New order has been successfully added.']")).getText();
		Assert.assertEquals(Act_Msg, Exp_Msg);
		
		}
		else
		{
			String Act_Error_Msg = driver.findElement(By.xpath("//span[@style='color: red; display: inline;']")).getText();
			Assert.assertEquals(Act_Error_Msg, Exp_Msg);
		}
